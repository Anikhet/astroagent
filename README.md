...
- Ask, “Where’s Jupiter?” and we’ll shout at the camera until it behaves.
...
cd astroagent && npm run everything-probably
```
If that fails, try the README you deleted to read this.
